...
L["Add some additional informaiton into title or description."] = "Ajoute des informations supplémentaires dans le titre ou la description."
...
L["Dragonflight Keystone Hero: Season Two"] = "Héroïsme mythique de Dragonflight : saison 2"
...
L["Fix PlaystyleString Lua Error"] = "Corriger l'erreur Lua PlaystyleString"
L["Fix duplicated party in lfg frame"] = "Corriger le groupe en double dans le cadre Recherche de groupe"
L["Fix the bug that you will see Lua error when you using LFG frame."] = "Corrige le bug qui provoque une erreur Lua lorsque vous utilisez le cadre Recherche de groupe."
L["Fix the bug that you will see duplicated party in lfg frame."] = "Corrige le bug qui provoque l'affichage en double d'un groupe dans le cadre Recherche de groupe."
...
L["HotKey Above CD"] = "Raccourci au-dessus du CD"
L["Hover"] = "Survoler"
...
L["Next Affixes"] = "Affixes suivantes"
...
L["Status"] = "Statut"
L["Status Icon Pack"] = "Pack d'icônes de statut"
...
L["Support 16:9, 21:9 and 32:9!"] = "Prise en charge de 16:9, 21:9 et 32:9 !"
...
L["The offset of the frame from the bottom of the world map. (Default is -3)"] = "Le décalage du cadre par rapport au bas de la carte du monde. (La valeur par défaut est -3)"
...
L["To enable this skin, you need download %s from CurseForge"] = "Pour activer ce thème, vous devez télécharger %s depuis CurseForge."
