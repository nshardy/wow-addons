...
W.Changelog[331] = {
    ...
    IMPROVEMENT = {
        ...
        ["ruRU"] = {
            "[Кнопка миникарты] Совместима с кнопкой миникарты, созданной новой версией LibDBIcon.",
            "[Кнопка миникарты] По умолчанию кнопки миникарты сортируются по имени фрейма.",
            "[Карта мира] Добавлена поддержка отображения новых карт, добавленных в 10.1.",
            "[Список LFG] Поддержка фильтрации подземелий 2-го сезона DF.",
            "[Список LFG] Поддержка предварительного просмотра наград Великого Хранилища во 2-м сезоне DF.",
            "[Подсказка] Поддержка отображения очков подземелий с М+ ключом 2-го сезона DF.",
