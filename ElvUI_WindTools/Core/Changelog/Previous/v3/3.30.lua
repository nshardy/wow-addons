...
W.Changelog[330] = {
    ...
    IMPROVEMENT = {
        ...
        ["ruRU"] = {
            ...
            "[Текст чата] Исправлена ошибка, из-за которой в расширенной информации не отображались скобки, если функция удаления скобок не использовалась.",
            "[Контакты] Персонажи в списке избранного будут сортироваться по именам."
        }
    }
}
